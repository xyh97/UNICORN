...
class Blip2Base(BaseModel):
    ...
    @classmethod
    def init_video_Qformer(cls, num_frame, hidden_size, num_attention_heads, num_hidden_layers=2):
        encoder_config = BertConfig.from_pretrained("bert-base-uncased")
        encoder_config.hidden_size = hidden_size
        encoder_config.num_attention_heads = num_attention_heads
        encoder_config.encoder_width = 1
        encoder_config.num_hidden_layers = num_hidden_layers
        # insert cross-attention layer every other block
        encoder_config.add_cross_attention = False
        encoder_config.cross_attention_freq = 1
        encoder_config.query_length = num_frame

...
class RunnerIter(RunnerBase):
    ...
    def train(self):
        ...
        if os.path.isfile(latest_ckpt):
            ...
            # self.train_loader._epoch = self.start_iters
            self.train_loader._dataloader.sampler.set_epoch(self.start_iters)
            self.train_loader.iter_loader = iter(self.train_loader.iter_loader)
        # if os.path.isfile(os.path.join(self.output_dir, "best.json")):
        for start_iters in range(
            ...
            if not self.evaluate_only:
                ...
                self._save_checkpoint(end_iters, is_latest=True)
    ...
    @main_process
    def _save_checkpoint(self, cur_iters, is_best=False, is_latest=False):
    ...
    def _load_checkpoint(self, url_or_filename):
        ...
        self.start_iters = checkpoint["iters"]
